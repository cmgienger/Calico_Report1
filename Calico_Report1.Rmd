...
```{r Check the Number of Observations for Each Lizard}
data %>%
...
```{r Map of Study Site}
leaflet() %>%
  setView(-115.418676, 36.151788, zoom = 13.5) %>% #lat-long of the place of interest
...
```
*Notice that the projection of the new object was set to UTM Zone 11 (All of Nevada).*<br>
